...
import 'package:fut/feature/matches/presentation/view/widgets/match_start_body.dart';

class MatchesStartScreen extends StatelessWidget {
  const MatchesStartScreen({super.key});
          ...
          children: [
            ...
            CustomScrollView(
              ...
              slivers: [
                ...
                const SliverToBoxAdapter(child: MatchStartBody())
              ],
            ),
          ],
        ),
