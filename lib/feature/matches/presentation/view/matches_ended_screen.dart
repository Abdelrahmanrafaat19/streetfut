...
import 'package:fut/feature/matches/presentation/view/widgets/matches_ended_body.dart';

class MatchesEndedScreen extends StatelessWidget {
  const MatchesEndedScreen({super.key});
          ...
          children: [
            Positioned.fill(
              child: SizedBox.expand(
                child: FittedBox(
                  fit: BoxFit.cover,
                  child: Image.asset("assetes/images/backgroundmatches.png"),
                ),
              ),
            ),
            CustomScrollView(
              ...
              slivers: [
                ...
                const SliverToBoxAdapter(child: MatchesEndedBody())
              ],
            ),
          ],
        ),
