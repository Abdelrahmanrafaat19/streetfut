...
import 'package:fut/feature/rating_player/presentation/views/widgets/rateing_body.dart';

class RatingPlayer extends StatelessWidget {
  const RatingPlayer({super.key});
        ...
        children: [
          Positioned.fill(
            child: SizedBox.expand(
              child: FittedBox(
                fit: BoxFit.cover,
                child: Image.asset("assetes/images/backgroundwallet.png"),
              ),
            ),
          ),
          CustomScrollView(
            ...
            slivers: [
              ...
              SliverToBoxAdapter(child: RateingBody())
            ],
          ),
        ],
      ),
