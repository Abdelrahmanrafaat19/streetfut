...
import 'package:fut/feature/referee_mode.dart/presentation/views/widget/test_refree_mode.dart';

class RefereeModeScreen extends StatelessWidget {
  const RefereeModeScreen({super.key});
        ...
        children: [
          ...
          CustomScrollView(
            ...
            slivers: [
              ...
              const SliverToBoxAdapter(child: TestRefreeMode())
            ],
          ),
        ],
      ),
