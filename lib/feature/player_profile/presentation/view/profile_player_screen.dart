...
import 'package:fut/feature/player_profile/presentation/view/widget/profile_player_body.dart';
            ...
            Positioned.fill(
              child: SizedBox.expand(
                child: FittedBox(
                  fit: BoxFit.cover,
                  child:
                      Image.asset("assetes/images/backgroundteamprofile.png"),
                ),
              ),
            ),
            CustomScrollView(
              ...
              slivers: [
                ...
                const SliverToBoxAdapter(child: ProfilePlayerBody())
              ],
            ),
          ],
        ),
