...
class StatisticsPlayerProfile extends StatefulWidget {
  const StatisticsPlayerProfile({super.key});

  @override
  State<StatisticsPlayerProfile> createState() =>
      _StatisticsPlayerProfileState();
}

class _StatisticsPlayerProfileState extends State<StatisticsPlayerProfile> {
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  width: width < 1000 ? width * 0.343776 : width * 0.343776,
                  height: width < 1000
                      ? (height * 0.362791) - 51.h
                      : ((height * 0.362791) * (2 / 3)) - 51.h,
